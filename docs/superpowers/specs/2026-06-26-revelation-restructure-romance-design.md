---
title: Revelation Restructure + Romance Architecture
date: 2026-06-26
scope: input/book-01/outline.md — chapters 2, 5, 7, 10, 11, 12, 13, 14–15, 18, 19, 20, 21, 22
status: approved
---

# Design: Revelation Restructure + Romance Architecture

## Problem Statement

Four structural problems identified in review:

1. **Ch 12** — Faye's friendship and the jam feud are introduced, wounded, and healed inside one chapter. The feud has no prior presence. The bakery window business beat arrives as a reward immediately after the hurt, which is backwards.

2. **Ch 13** — Too vague for the harness to draft. No named clue, no named suspect, no named innocent explanation.
...
### 2. Chapter 13 — The False Dawn (full specificity)
...
Calloway is already partially cleared going into ch 14. The old papers chapter can confirm his alibi in a single line and focus entirely on its real job: the pivot from Neil's present enemies to the old death.
...
### 4. Chapter 19 — The Evening Accounted For

**Full revision of current Ch 19 "A Name After Ten Years".**
...
### 5. Chapter 20 — The Story She Chose to Tell

**Full revision of current Ch 20 "The Sinner".**
...
The inquest note trails off before it explains Neil's role. The cause of death is recorded as natural. But Neil was present, and he changed overnight, and Mary has been waiting ever since.
...
### 6. Chapter 21 — What the Box Holds

**Full revision of current Ch 21 "The Mercy".**
