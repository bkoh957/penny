...
### Closing
Cliffhanger — the porch light dies mid-sentence.
...
### Closing
Cliffhanger — the tin is empty where the papers should be.
...
### Closing
Cliffhanger — the lock clicks from the wrong side.
...
### Closing
Cliffhanger — Artie's sentence stops before the name.
...
### Closing
Irony — the shop reopens the same hour Mary is taken.
...
### Closing
Promise of action — Maggie sets the unopened envelope on the sill.
